...
Irvine. The sun has set, and the park is quiet, but something feels off. You notice a strange figure in the distance, \
...
Their name is <playername>. <Playername>, this is Dejian, Wasi, and Kyle. As far as I know, we’re the only survivors in this mess.” Wasi speaks up. \
